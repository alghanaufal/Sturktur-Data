...
void addFirstB(char nama[], char kode[], list *L)
{
    eBaris *baru;
...
void addFirstK(char brg[], eBaris *L)
{
    eKolom *baru;
...
void addAfterB(eBaris *prev, char nama[], char kode[])
{
    eBaris *baru;
    baru = (eBaris *)malloc(sizeof(eBaris));
    strcpy(baru->kontainer.nama, nama);
...
void addAfterK(eKolom *prev, char brg[])
{
    eKolom *baru;
    baru = (eKolom *)malloc(sizeof(eKolom));
    strcpy(baru->kontainer_kol.brg, brg);
...
void addLastB(char nama[], char kode[], list *L)
{
    if ((*L).first == NULL)
    {
        /*jika list adalah list kosong*/
        addFirstB(nama, kode, L);
    }
    else
    {
        ...
        addAfterB(last, nama, kode);
    }
}

void addLastK(char brg[], eBaris *L)
{
    if ((*L).col == NULL)
    {
        /*jika list adalah list kosong*/
